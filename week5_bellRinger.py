...
last_a_index = print(magic.rindex('c'))
...
# From Descriptions:
# Extract the name of the famous personality from the quote "Ask not what your country can do for you — ask what you can do for
...
phrase4 = "Supercalifragilisticexpialidocious"
length_of_phrase4 = print(len(phrase4))

count_of_1 = print(phrase4.count('1'))
